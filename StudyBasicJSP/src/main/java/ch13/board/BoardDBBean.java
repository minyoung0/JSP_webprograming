...
public class BoardDBBean {
	...
	// board 테이블에 저장된 전체 글의 수를 얻어냄(select 문)<=list.jsp에서 사용
	...
	// 글의 목록(복수 개의 글)을 가져옴(select 문)<=list.jsp에서 사용
	...
	// 글의 냉뇽을 보기(1개)(select)<=content 페이지에서 사용
	...
	// 글 수정 폼에서 사용할 글의 내용<=updateForm에서 사용
	...
	//글 삭제처리시 사용 delete <- deletePro 페이지에서 사용
